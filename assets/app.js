const copy = {
  id: {
    ...
    lede: 'Profesional Tech & IT, system integrator, petani durian premium, dan pembangun agritech yang menghubungkan sistem digital dengan kebutuhan di lapangan.',
    primary: 'Mari berdiskusi',
    secondary: 'Lihat perjalanan',
    aboutLabel: 'Tentang',
    about: 'Dari Baris Kode ke Tanah<br />Subur Nusantara.',
    intro: 'Selama 20+ tahun sebagai seorang profesional Tech & IT, saya pernah bekerja di perusahaan korporat multinasional hingga startup unicorn, mencakup e-commerce, fintech, digital banking, dan teknologi logistik.<br /><br />Sejak 2021, fokus tersebut juga bertumbuh di kebun durian premium di Solo, Jawa Tengah. Sejak 2023, perjalanan berlanjut melalui toko durian premium di Jakarta dan BSD, sambil membangun fondasi agritech yang relevan bagi pertanian Indonesia.',
    values: [
    ...
    competencies: [
      ...
      ['Digital Transformation', 'Mengubah operasional manual menjadi sistem terintegrasi yang siap skala, transparan, dan mudah dipantau setiap saat.'],
    ...
    roles: [
      ...
      ['Profesional Tech & IT', 'IT & System Integrator', 'Konsultasi IT', 'Mengelola kebutuhan IT serta mendampingi organisasi melalui arsitektur, infrastruktur, dan integrasi sistem.', 'Indonesia'],
    ...
    notes: [
      ['Teknologi & Sistem', 'Membangun sistem yang bekerja untuk manusia dan operasi sehari-hari.'],
  ...
  en: {
    ...
    roles: [
      ...
      ['Technology & IT professional', 'IT & System Integrator', 'IT consulting', 'Managing IT needs and guiding organisations through architecture, infrastructure, and system integration.', 'Indonesia'],
